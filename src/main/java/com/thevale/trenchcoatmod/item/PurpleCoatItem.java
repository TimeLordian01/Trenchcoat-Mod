...
public class PurpleCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:purple_coat_chestplate")
	public static final Item body = null;


	public PurpleCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/purple_coat.png";
			}
		}.setRegistryName("purple_coat_chestplate"));
	}
