...
public class PinkCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:pink_coat_chestplate")
	public static final Item body = null;


	public PinkCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/pink_coat.png";
			}
		}.setRegistryName("pink_coat_chestplate"));
	}
