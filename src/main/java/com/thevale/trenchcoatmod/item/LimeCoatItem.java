...
public class LimeCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:lime_coat_chestplate")
	public static final Item body = null;


	public LimeCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 15);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/lime_coat.png";
			}
		}.setRegistryName("lime_coat_chestplate"));
	}
