...
public class GreenCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:green_coat_chestplate")
	public static final Item body = null;


	public GreenCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/green_coat.png";
			}
		}.setRegistryName("green_coat_chestplate"));
	}
