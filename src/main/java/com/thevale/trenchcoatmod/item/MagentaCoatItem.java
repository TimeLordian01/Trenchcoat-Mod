...
public class MagentaCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:magenta_coat_chestplate")
	public static final Item body = null;


	public MagentaCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/magenta_coat.png";
			}
		}.setRegistryName("magenta_coat_chestplate"));
	}
