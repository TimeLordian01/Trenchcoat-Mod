...
public class BlackCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:black_coat_chestplate")
	public static final Item body = null;
	@ObjectHolder("trenchcoatmod:blue_coat_leggings")
	public static final Item legs = null;

	public BlackCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedLeftLeg = new ModelTrenchcoat().LeftLeg;
				armorModel.bipedRightLeg = new ModelTrenchcoat().RightLeg;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/black_coat.png";
			}
		}.setRegistryName("black_coat_chestplate"));
	}
