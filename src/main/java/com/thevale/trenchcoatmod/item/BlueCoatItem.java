...
public class BlueCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:blue_coat_chestplate")
	public static final Item body = null;

	public BlueCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 19);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/blue_coat.png";
			}
		}.setRegistryName("blue_coat_chestplate"));
	}
