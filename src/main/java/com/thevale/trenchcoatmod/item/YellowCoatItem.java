...
public class YellowCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:yellow_coat_chestplate")
	public static final Item body = null;

	public YellowCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/yellow_coat.png";
			}
		}.setRegistryName("yellow_coat_chestplate"));
	}
