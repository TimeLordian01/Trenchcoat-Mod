...
public class CyanCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:cyan_coat_chestplate")
	public static final Item body = null;


	public CyanCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/cyan_coat.png";
			}
		}.setRegistryName("cyan_coat_chestplate"));
	}
