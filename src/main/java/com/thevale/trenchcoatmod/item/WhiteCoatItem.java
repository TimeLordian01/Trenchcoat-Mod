...
public class WhiteCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:white_coat_chestplate")
	public static final Item body = null;

	public WhiteCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/white_coat.png";
			}
		}.setRegistryName("white_coat_chestplate"));
	}
