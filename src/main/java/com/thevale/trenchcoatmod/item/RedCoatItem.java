...
public class RedCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:red_coat_chestplate")
	public static final Item body = null;


	public RedCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/red_coat.png";
			}
		}.setRegistryName("red_coat_chestplate"));
	}
