...
public class BrownCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:brown_coat_chestplate")
	public static final Item body = null;


	public BrownCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/brown_coat.png";
			}
		}.setRegistryName("brown_coat_chestplate"));
	}
