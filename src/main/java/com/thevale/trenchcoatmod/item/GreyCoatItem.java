...
public class GreyCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:grey_coat_chestplate")
	public static final Item body = null;


	public GreyCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/grey_coat.png";
			}
		}.setRegistryName("grey_coat_chestplate"));
	}
