...
public class LightBlueCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:light_blue_coat_chestplate")
	public static final Item body = null;


	public LightBlueCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 18);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/light_blue_coat.png";
			}
		}.setRegistryName("light_blue_coat_chestplate"));
	}
