...
public class LightGreyCoatItem extends TrenchcoatmodModElements.ModElement {

	@ObjectHolder("trenchcoatmod:light_grey_coat_chestplate")
	public static final Item body = null;


	public LightGreyCoatItem(TrenchcoatmodModElements instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TrenchcoatsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "trenchcoatmod:textures/light_grey_coat.png";
			}
		}.setRegistryName("light_grey_coat_chestplate"));
	}
